...
#-------------------------------------------------------------------------------------------------
input_volpath =  '/scra3/ft21894/radx/bin/output_0713/20150618/14001600/'
input_volpath2 = '/scra3/ft21894/radx/bin/output_0713/20150618/14001600/'
radarvollist = sorted(glob.glob(input_volpath+'*KUEX*'))
radarvollist2 = sorted(glob.glob(input_volpath2+'*KOAX*'))
...
#	gatefilter2 = pyart.correct.despeckle.despeckle_field(base2, 'zdr_acorr', gatefilter=gatefilter2)
	...
	grid_limits = ((0, 20000), (-300000.0, 200000.0), (-200000.0, 300000.0))
	grid_roi    = 2000
